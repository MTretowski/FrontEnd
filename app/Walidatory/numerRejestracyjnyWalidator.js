app.service('numerRejestracyjnyWalidator', function () {

    this.sprawdzNumerRejestracyjny = function (numerRejestracyjny) {

        let blad = 'Wprowadzony numer rejestracyjny jest niezgodny z polskim prawem\n';
        ...
        if (numerRejestracyjny.length === 7) {
            for (i = 0; i < zasoby7literowe.length; i++) {
                if (zasoby7literowe[i].test(numerRejestracyjny)) {
                    blad = '';
                }
            }
        }

        else if (numerRejestracyjny.length === 8) {
            for (i = 0; i < zasoby8literowe.length; i++) {
                if (zasoby8literowe[i].test(numerRejestracyjny)) {
                    blad = '';
                }
            }
        }
        ...
        if (blad === '') {
            ...
            for (i = 0; i < wyroznikiPowiatow.length; i++) {
                if (new RegExp('^' + wyroznikiPowiatow[i]).test(numerRejestracyjny)) {
                    return '';
                }
            }
